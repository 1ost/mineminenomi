    ...
    public static class RustTouch extends Ability {
        ...
        public void hitEntity(EntityPlayer player, EntityLivingBase target) {
            if (!this.isOnCooldown()) {
                target.addPotionEffect(new PotionEffect(Potion.getPotionById(2), 30 * 4, 2));
                target.addPotionEffect(new PotionEffect(Potion.getPotionById(4), 30 * 4, 4));
                target.addPotionEffect(new PotionEffect(Potion.getPotionById(20), 30 * 4, 1));
