...
{		
	...
	private void equal(EntityPlayer target, int value)
	{
		...
		if(value <= Values.MAX_GENERAL)
		{
			...
			if(WyDebug.isDebug())
				WyHelper.sendMsgToPlayer(target, TextFormatting.GREEN + "" + TextFormatting.ITALIC + "[DEBUG] " + target.getCommandSenderName() + " now has " + value + " extol");
		}			
	}
	...
	private void subtract(EntityPlayer target, int value)
	{
		...
		if(WyDebug.isDebug())
			WyHelper.sendMsgToPlayer(target, TextFormatting.GREEN + "" + TextFormatting.ITALIC + "[DEBUG] Subtracted " + value + " extol from " + target.getCommandSenderName());
	}
	...
	private void add(EntityPlayer target, int value)
	{
		...
		if(WyDebug.isDebug())
			WyHelper.sendMsgToPlayer(target, TextFormatting.GREEN + "" + TextFormatting.ITALIC + "[DEBUG] Added " + value + " extol to " + target.getCommandSenderName());
	}
