...
public class ListAttributes 
{
	...
	public static final AbilityAttribute TRUNK_SHOT = new AbilityAttribute("Trunk Shot").setAbilityCooldown(7).setProjectileModel(new ModelCube()).setProjectileTexture("zouskin").setProjectileSize(2.5, 2.5, 4).setProjectileColor("838993").setProjectileDamage(10).addEffects(EffectType.PROJECTILE, new PotionEffect(Potion.getPotionById(18), 5 * 20)).setProjectilePhysical();
	
	public static final AbilityAttribute SOUL_PARADE = new AbilityAttribute("Soul Parade").addEffects(EffectType.USER, new PotionEffect(Potion.getPotionById(11), 30, 100), new PotionEffect(Potion.getPotionById(2), 30, 100)).setAbilityCooldown(5).setAbilityPassive();
	...
	public static final AbilityAttribute BLUE_FLAMES_OF_RESURRECTION = new AbilityAttribute("Blue Flames of Resurrection").setAbilityCooldown(20).addEffects(EffectType.USER, new PotionEffect(Potion.getPotionById(10), 3 * 20, 4));
	...
	public static final AbilityAttribute BLACK_WORLD = new AbilityAttribute("Black World").setAbilityCooldown(25).addEffects(EffectType.AOE, new PotionEffect(Potion.getPotionById(2), 200, 100), new PotionEffect(Potion.getPotionById(4), 200, 100), new PotionEffect(Potion.getPotionById(15), 200, 2)).setEffectRadius(20);
...
//	public static final AbilityAttribute SHINOKUNI = new AbilityAttribute("Shinokuni");
	...
	public static final AbilityAttribute VENOM_ROAD = new AbilityAttribute("Venom Road").setAbilityCooldown(8).setProjectileDamage(20).setProjectileModel(new ModelHydra()).setProjectileTexture("hydra").setProjectileSize(2, 2, 2.4).addEffects(EffectType.PROJECTILE, new PotionEffect(Potion.getPotionById(19), 500, 1));
	public static final AbilityAttribute CHLORO_BALL = new AbilityAttribute("Chloro Ball").setAbilityCooldown(6).setProjectileDamage(10).setProjectileModel(new ModelSphere()).setProjectileColor("A020F0").setProjectileSize(5, 5, 5).addEffects(EffectType.PROJECTILE, new PotionEffect(Potion.getPotionById(19), 240, 1));
	public static final AbilityAttribute HYDRA = new AbilityAttribute("Hydra").setAbilityCooldown(8).setProjectileDamage(30).setProjectileModel(new ModelHydra()).setProjectileTexture("hydra").setProjectileSize(2, 2, 2.4).setProjectileTicks(10).addEffects(EffectType.PROJECTILE, new PotionEffect(Potion.getPotionById(19), 500, 1));
	
	public static final AbilityAttribute CANDLE_LOCK = new AbilityAttribute("Candle Lock").setAbilityCooldown(15).setProjectileDamage(6).setProjectileModel(new ModelCube()).setProjectileColor("A2ADD0").setProjectileSize(.5, .5, 1).addEffects(EffectType.PROJECTILE, new PotionEffect(Potion.getPotionById(2), 400, 100), new PotionEffect(Potion.getPotionById(4), 400, 100), new PotionEffect(Potion.getPotionById(8), 400, -1));
...
//	public static final AbilityAttribute SHADOWSASGARD = new AbilityAttribute("Shadow's Asgard").setAbilityCooldown(400).addTasks(Tasks.shadowsasgard);
	...
	public static final AbilityAttribute WHITE_STRIKE = new AbilityAttribute("White Strike").setAbilityCooldown(35).addEffects(EffectType.AOE, new PotionEffect(Potion.getPotionById(2), 300, 1), new PotionEffect(Potion.getPotionById(4), 300, 1), new PotionEffect(Potion.getPotionById(8), 300, -10)).setEffectRadius(30);
	...
	public static final AbilityAttribute WHITE_SNAKE = new AbilityAttribute("White Snake").setAbilityCooldown(5).setProjectileTicks(120).setProjectileModel(new ModelCube()).setProjectileSpeed(5).setProjectileSize(0, 0, 0).setProjectileDamage(30).addEffects(EffectType.PROJECTILE, new PotionEffect(Potion.getPotionById(19), 120, 0));
	public static final AbilityAttribute WHITE_OUT = new AbilityAttribute("White Out").setAbilityCooldown(4).setProjectileModel(new ModelCube()).setProjectileSpeed(5).setProjectileSize(0, 0, 0).setProjectileDamage(5).addEffects(EffectType.PROJECTILE, new PotionEffect(Potion.getPotionById(2), 240, 1), new PotionEffect(Potion.getPotionById(4), 240, 1), new PotionEffect(Potion.getPotionById(8), 240, -10));
	...
	public static final AbilityAttribute FLASH = new AbilityAttribute("Flash").setAbilityCooldown(5).addEffects(EffectType.AOE, new PotionEffect(Potion.getPotionById(15), 7 * 20, 3), new PotionEffect(Potion.getPotionById(2), 7 * 20, 1)).setEffectRadius(10);
	...
	public static final AbilityAttribute ICE_BALL = new AbilityAttribute("Ice Ball").setAbilityCooldown(6).setProjectileDamage(5).setProjectileModel(new ModelSphere()).setProjectileColor("00FFFF").setProjectileSize(5, 5, 5).addEffects(EffectType.PROJECTILE, new PotionEffect(Potion.getPotionById(2), 100, 0), new PotionEffect(Potion.getPotionById(4), 100, 0));
	public static final AbilityAttribute ICE_AGE = new AbilityAttribute("Ice Age").setAbilityCooldown(15).addEffects(EffectType.AOE, new PotionEffect(Potion.getPotionById(2), 200, 100), new PotionEffect(Potion.getPotionById(4), 200, 100)).setEffectRadius(20);
	...
	public static final AbilityAttribute KAMIE = new AbilityAttribute("Kamie").setAbilityCooldown(10).addEffects(EffectType.USER, new PotionEffect(Potion.getPotionById(11), 20, 100)).setAbilityPassive();
	...
	public static final AbilityAttribute SAMEHADA_SHOTEI = new AbilityAttribute("Samehada Shotei").setAbilityCooldown(10).addEffects(EffectType.USER, new PotionEffect(Potion.getPotionById(11), 10, 120), new PotionEffect(Potion.getPotionById(2), 10, 120), new PotionEffect(Potion.getPotionById(8), 30, -100)).setAbilityPassive();
